package com.amosh.zakwa.core.domain.utils
...
object EncryptionUtils {
    ...
    private val rawKey : ByteArray
        get() {
            val key : SecretKey = SecretKeySpec(keyValue, ENCRYPTION_ALGORITHM)
            return key.encoded
        }
    ...
    private fun encrypt(raw : ByteArray, clear : ByteArray) : ByteArray {
        val secretKey : SecretKey = SecretKeySpec(raw, ENCRYPTION_ALGORITHM)
    ...
    private fun decrypt(encrypted : ByteArray) : ByteArray {
        val secretKey : SecretKey = SecretKeySpec(keyValue, ENCRYPTION_ALGORITHM)
        val cipher = Cipher.getInstance(ENCRYPTION_ALGORITHM)
